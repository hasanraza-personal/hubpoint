...
const CardHead = ({ name, username, photo }) => {
  ...
  if (process.env.REACT_APP_ENV === "production") {
    link = `https://hubpoint.me/user/${username}`;
  } else {
    link = `https://hubpoint.me/user/${username}`;
  }
  ...
  const handleShare = () => {
    if (
      ...
      setWhatsappLink(
        `https://api.whatsapp.com/send?phone=&text=https://hubpoint.me/user/${username}`
      );
    } else {
      setWhatsappLink(
        `https://web.whatsapp.com/send?phone=&text=https://hubpoint.me/user/${username}`
      );
    }
  };
