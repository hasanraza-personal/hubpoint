  ...
  return (
    <>
      <Container mt="20px" mb="55px" fontFamily="SFPro">
        ...
        <Box className="privacy-policy-short-info">
          HubPoint’s Privacy Policy describes how HubPoint collects, uses, and
        ...
        <Box className="privacy-policy-desc">
          At HubPoint, accessible from{" "}
          <Link href="https://www.hubpoint.me" color="#246dfb !important">
            https://www.hubpoint.me
          </Link>
          , one of our main priorities is the privacy of our visitors. This
          Privacy Policy document contains types of information that is
          collected and recorded by HubPoint and how we use it.
        </Box>
        <Box className="privacy-policy-desc">
        ...
        <Box className="privacy-policy-desc">
          ...
          shared and/or collect in HubPoint.
        </Box>
        ...
        <Box className="privacy-policy-desc">
          ...
          information, including items such as name, email address and gender.
        </Box>
        <Box className="privacy-policy-or">OR</Box>
        <Box className="privacy-policy-desc">
          When you login through your Google account, we will collect
          information, such as name, email address and profile photo.
        </Box>
        <Box className="privacy-policy-desc">
          We receive certain Personal Data directly from you when you provide us
          with your social media details to be displayed on our website.
        </Box>
